...
Coinwink is a web application for creating and receiving [cryptocurrency price alerts](https://coinwink.com/) for Bitcoin, Ethereum and other 2000+ crypto assets via e-mail and SMS, and for managing [cryptocurrency portfolio](https://coinwink.com/portfolio).
