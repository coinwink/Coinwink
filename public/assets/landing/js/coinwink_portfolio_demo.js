...
function cwAddCoin() {
    // return alert("Please log in to your Coinwink account.");
...
function load_portfolio(json) {
    if (portfolio.length < 1) {
        ...
        function build_table(json) {
            ...
            headerRow += '<header style="margin-bottom:0px;"><h3 class="text-header" style="color:white;margin-top:0px;">Portfolio</h3></header><select onchange="selectcurrency(1)" id="selectcurrency1" class="select-css"><option value="USD">USD</option><option value="BTC">BTC</option><option value="ETH">ETH</option><option value="percent">%</option><option value="EUR">EUR</option><option value="GBP">GBP</option><option value="AUD">AUD</option><option value="CAD">CAD</option><option value="BRL">BRL</option><option value="MXN">MXN</option><option value="JPY">JPY</option><option value="SGD">SGD</option></select>'
            ...
            json.map(function(row) {
                ...
                row["coin_id"]+
                '"><a target="_blank" style="padding-top: 0px;" class="portfoliocoin" href="https://coinwink.com/' +
                getCoinName(row["coin_id"]).toLowerCase() +
            ...
            headerRow +
            bodyRows+
            '<div style="display:none;">Total value: <b><span id="totalValue"></span></b></div>';
    ...
    if (selected_c == "percent") {
        ...
        for(var i = 0; i < cw_cmc.length; i++) {
            ...
            if (arraycoin['id'] == id) {
                ...
                if (invested_c == 'USD' || invested_c == 'BTC' || invested_c == 'ETH' ) {
                    ...
                    var net_profit = amount * arraycoin["price_usd"] * cw_rates['eur'];
                }
                else if (invested_c == 'GBP') {
                    var net_profit = amount * arraycoin["price_usd"] * cw_rates['gbp'];
                }
                else if (invested_c == 'CAD') {
                    var net_profit = amount * arraycoin["price_usd"] * cw_rates['cad'];
                }
                else if (invested_c == 'AUD') {
                    var net_profit = amount * arraycoin["price_usd"] * cw_rates['aud'];
                }
                else if (invested_c == 'MXN') {
                    var net_profit = amount * arraycoin["price_usd"] * cw_rates['mxn'];
                }
                else if (invested_c == 'BRL') {
                    var net_profit = amount * arraycoin["price_usd"] * cw_rates['brl'];
                }
                else if (invested_c == 'SGD') {
                    var net_profit = amount * arraycoin["price_usd"] * cw_rates['sgd'];
                }
                else if (invested_c == 'JPY') {
                    var net_profit = amount * arraycoin["price_usd"] * cw_rates['jpy'];
                }
        ...
        for(var i = 0; i < cw_cmc.length; i++) {
            ...
            if (arraycoin['id'] == id) {
                ...
                if (invested_c == 'BTC') {
                    investedValue = investedValue * cw_cmc[0]['price_usd'];
                }
                else if (invested_c == 'ETH') {
                    investedValue = investedValue * cw_cmc[1]['price_usd'];
                }
                else if (invested_c == 'EUR') {
                    investedValue = investedValue / cw_rates['eur'];
                }
                else if (invested_c == 'GBP') {
                    investedValue = investedValue / cw_rates['gbp'];
                }
                else if (invested_c == 'CAD') {
                    investedValue = investedValue / cw_rates['cad'];
                }
                else if (invested_c == 'AUD') {
                    investedValue = investedValue / cw_rates['aud'];
                }
                else if (invested_c == 'MXN') {
                    investedValue = investedValue / cw_rates['mxn'];
                }
                else if (invested_c == 'BRL') {
                    investedValue = investedValue / cw_rates['brl'];
                }
                else if (invested_c == 'SGD') {
                    investedValue = investedValue / cw_rates['sgd'];
                }
                else if (invested_c == 'JPY') {
                    investedValue = investedValue / cw_rates['jpy'];
                }
                ...
                if (selected_c == 'BTC') {
                    profit = profit / cw_cmc[0]['price_usd'];
                }
                else if ( selected_c == 'ETH' ) {
                    profit = profit / cw_cmc[1]['price_usd'];
                }
                else if (selected_c == 'EUR') {
                    profit = profit * cw_rates['eur'];
                }
                else if (selected_c == 'GBP') {
                    profit = profit * cw_rates['gbp'];
                }
                else if (selected_c == 'CAD') {
                    profit = profit * cw_rates['cad'];
                }
                else if (selected_c == 'AUD') {
                    profit = profit * cw_rates['aud'];
                }
                else if (selected_c == 'MXN') {
                    profit = profit * cw_rates['mxn'];
                }
                else if (selected_c == 'BRL') {
                    profit = profit * cw_rates['brl'];
                }
                else if (selected_c == 'SGD') {
                    profit = profit * cw_rates['sgd'];
                }
                else if (selected_c == 'JPY') {
                    profit = profit * cw_rates['jpy'];
                }
                    ...
                    if (arraycoin['id'] == coin.coin_id) {
                        ...
                        if (cur_p != "BTC" && cur_p != "ETH") {
                            ...
                            if (cur_p == "USD") {
                                ...
                                coin_price = arraycoin['price_usd'] * cw_rates[cur_p.toLowerCase()];
                                coin_value = coin_price * coin.amount;
                                coin_price = formatPrice(coin_price);
                            }
