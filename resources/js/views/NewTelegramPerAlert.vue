...
<template>
    <widget style="text-align:center;" :title="'New Telegram Alert'" :secondary="'Percentage'">
        <span v-if="store.userLoggedIn">
            <div v-if="tg_user == ''" style="padding-left:20px;padding-right:20px;">
                ...
                <form @submit.prevent="validateUsername()">
                    ...
                    <input type="submit"  class="button-main" value="Validate">
                </form>
            ...
            <div v-if="store.alertCreated" style="padding-left:20px;padding-right:20px;">
                <alert-created :form="form" :type="'tg_per'" @reset="resetForm" />
            </div>
        </span>
        <span v-else>
            <div style="margin-top:50px;padding-left:20px;padding-right:20px;">
                To receive Telegram crypto percentage alerts, please create an account
            </div>
            <br>
