...
<head>
	...
	<title>Coinwink - Crypto Alert</title>
		...
		<div class="content">
			...
			<div style="font-size:18px;line-height:140%;">
				...
				<?php 
					...
					// $CMCdata = array_values($cmc);
					$cmc = json_decode($cmc[0]->json, true);
					// var_dump($cmc);
					// exit;
					$i = 0;
					foreach ($cmc as $coin) {
				...
				<a href="https://coinmarketcap.com/currencies/<?php echo $slug; ?>/" target="_blank">
					<img src="/img/coins/128x128/<?php echo $alert[0]->coin_ID ?>.png" width="40">
				</a>
