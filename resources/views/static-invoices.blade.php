...
<div class="container" id="account">
        ...
        <header>
        <h2 class="text-header" style="color:white;">My Invoices</h2>
        </header>
            ...
            <div style="font-size:18px;line-height:140%;">
                ...
                <?php 
                    foreach ($invoices as $invoice) {
                        ?>
                        <a href="<?php echo($invoice['url']); ?>" class="blacklink" target="_blank">Link</a> | <a href="<?php echo($invoice['pdf']); ?>" class="blacklink" target="_blank">PDF</a>
                        <br>
                        <?php echo(gmdate("Y-m-d", $invoice['created'])); ?>
                        <br>
                        <br>
                <?php 
                    }
